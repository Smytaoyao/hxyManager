...
public class SysMenuController extends AbstractController {
	...
	public R nav(@RequestParam Map<String,Object> params){
		int ismobile=isEmpty(params.get("ismobile"))?0:Integer.parseInt(params.get("ismobile").toString());
		List<SysMenuEntity> menuList = sysMenuService.getUserMenuList(getUserId(),ismobile);
